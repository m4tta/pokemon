...
const PokemonCard = ({ pokemon, withType }: PokemonCardTypes) => {
  ...
  return (
    ...
    >
      <Center margin="auto 0 0 0" padding="16px">
        <Image maxHeight="175px" width="150px" src={pokemon.image} />
      </Center>
      <Stack padding="8px 12px" bgColor="#f3f2f2" justifyContent="space-between">
        <Stack vertical>
